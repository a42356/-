...
var tl = gsap.timeline({paused:true}); //pause default


//collapse menu
tl.to(menuitem1, speed, {top: 10, ease:Quint.easeOut}, "label--1"); 

if ($(window).width() > 500) {
tl.to(menuitem3, speed, {top: -10, ease:Quint.easeOut}, "label--1");
}else{
tl.to(menuitem3, speed, {top: -5, ease:Quint.easeOut}, "label--1");
}
tl.to([menuitem1, menuitem2, menuitem3], speed, {rotation: -90, ease:Quint.easeOut});
tl.to(menuitem1, speed, {left: 0,rotation: 45, ease:Quint.easeOut}, "label--2");
tl.to(menuitem2, speed, {opacity: 0,ease:Quint.easeOut}, "label--2");
tl.to(menuitem3, speed, {right: 0,rotation: -45, ease:Quint.easeOut}, "label--2"); 
...
menu.click(function() {
    ...
    if ( $(this).hasClass("active") ) {
        divs.css({"position":"relative","left":"200px"});
        tl.play(); 
    }  
    else {
        divs.css({"position":"relative","left":"0px"});
        tl.reverse(); 
    }
});
...
banner_x[0].classList.remove("op");
    ...
    setInterval(function(){Check_Time1()}, 4000);
    setInterval(function(){Check_Time2()}, 8000);
